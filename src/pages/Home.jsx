  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto w-full">
        <div className="bg-gradient-to-r from-orange-100 to-rose-100 rounded-2xl overflow-hidden flex flex-col md:flex-row items-center">
          <div className="p-10 md:w-1/2">
            <span className="text-sm font-bold text-primary tracking-wider uppercase mb-2 block">Special Offer</span>
      ...
      <section className="container mx-auto px-4 py-12">
        ...
        {loading ? (
          <div className="text-center py-10 text-gray-500">Loading featured products...</div>
        ) : (
